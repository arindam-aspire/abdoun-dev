...
import { fetchAgentDashboardSummary } from "@/features/agent/dashboard/agentDashboardSummarySlice";
import {
...
type UseAgentDashboardState = {
  ...
  loading: boolean;
  /** Set when dashboard fetch failed; user-facing message from the store thunk. */
  error: string | null;
};
