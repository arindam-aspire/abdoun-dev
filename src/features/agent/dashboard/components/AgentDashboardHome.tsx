...
import { AgentDashboardHomeSkeleton } from "@/features/agent/dashboard/components/AgentDashboardHomeSkeleton";
...
export function AgentDashboardHome() {
  ...
  useEffect(() => {
    ...
    const message = error ?? tAgent("loadDashboardError");
  ...
  if (error || !data) {
    const fallbackErrorMessage = error ?? tAgent("loadDashboardError");
