...
export type AdminPropertyDetailsTabKey = "overview" | "amenities" | "location" | "documents";
        ...
        >
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <span className={`${isActive ? "text-primary" : "text-charcoal/60"} inline-flex`}>{tab.icon}</span>
                <span>{tab.label}</span>
              </button>
            );
          })}
