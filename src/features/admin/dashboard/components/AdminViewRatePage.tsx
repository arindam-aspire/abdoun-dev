...
import { AdminViewRatePageSkeleton } from "@/features/admin/dashboard/components/AdminViewRatePageSkeleton";
import { fetchAdminPropertyPerformance } from "@/features/admin/dashboard/api/adminDashboard.api";
