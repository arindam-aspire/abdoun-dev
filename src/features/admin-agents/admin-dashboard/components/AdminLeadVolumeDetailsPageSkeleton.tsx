...
export function AdminLeadVolumeDetailsPageSkeleton() {
  return (
    <div className="space-y-6" aria-busy="true" aria-label="Loading lead volume">
      <Skeleton className="h-4 w-40 rounded-md" />

      <div className="space-y-2 px-1">
        <Skeleton className="h-9 w-[min(100%,20rem)] max-w-lg rounded-md" />
        <Skeleton className="h-4 w-[min(100%,30rem)] max-w-2xl rounded-md" />
      </div>
