...
export async function createAndSubmitAdminPropertySubmission(
  ...
  const response = await authApi.post<StandardApiResponse<AdminCreateAndSubmitResponse>>(
...
export async function createAdminPropertySubmissionDraft(
  ...
  const response = await authApi.post<StandardApiResponse<AdminDraftResult>>(
...
export async function updateAdminPropertySubmissionDraft(
  ...
  const response = await authApi.patch<StandardApiResponse<AdminDraftResult>>(
...
export async function submitExistingAdminPropertySubmission(
  ...
  const response = await authApi.post<StandardApiResponse<AdminSubmitExistingDraftResult>>(
...
export async function assignPropertyToAgent(
  ...
  const response = await authApi.patch<StandardApiResponse<AssignPropertyAgentResponse>>(
...
export async function fetchAdminSubmissions(params: {
  ...
  const response = await authApi.get<StandardApiResponse<AdminSubmissionListResponse>>(
    "/admin/property-submissions",
    {
      params: {
        ...params,
...
export async function fetchAdminSubmissionDetail(
  ...
  const response = await authApi.get<StandardApiResponse<AdminSubmissionDetailResponse>>(
    `/admin/property-submissions/${submissionId}`,
  );
  return unwrap(response.data);
}
...
export type AdminDraftSubmissionsListData = {
  items: AdminDraftSubmissionItem[];
  total: number;
  page: number;
  limit: number;
};
...
export async function fetchAdminPropertyDrafts(params: {
  ...
  const response = await authApi.get<StandardApiResponse<AdminDraftSubmissionsListData>>(
...
export async function reviewAdminSubmission(
  ...
  const response = await authApi.post<StandardApiResponse<AdminSubmissionReviewResponse>>(
