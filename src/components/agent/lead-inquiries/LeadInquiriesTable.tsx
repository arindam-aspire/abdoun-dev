          ...
          <tbody>
            {leads.map((row) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-charcoal/80 max-w-[180px] truncate" title={leadDisplay(row)}>
                  {leadDisplay(row)}
                </td>
                <td className="px-4 py-3 text-charcoal/80 whitespace-nowrap">{formatDate(row.dateReceived)}</td>
