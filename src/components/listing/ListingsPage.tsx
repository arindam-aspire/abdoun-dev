...
import { Building2, Eye, Pencil, Plus, Trash2, Upload } from "lucide-react";
import {
  deleteListing,
  getListings,
  publishDraft,
      ...
      <DialogRoot open={!!editing} onClose={closeEdit}>
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-2">
            <Label htmlFor="admin-edit-listing-title">{t("tableTitle")}</Label>
            <Input
              id="admin-edit-listing-title"
              value={editTitle}
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-edit-listing-price">Price (JOD)</Label>
            <Input
              id="admin-edit-listing-price"
              type="number"
              min={0}
              value={editPrice}
